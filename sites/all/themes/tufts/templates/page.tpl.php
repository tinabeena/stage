...
//        print drupal_render(_block_get_renderable_array(_block_render_blocks(array($block))));;
    ...
    <div class="footer-column col-three clearfix">
        ...
        <div class="right">
            <ul>
                ...
                <li><a href="http://tusk.tufts.edu/view/course/HSDB/1185" target="_blank">TUSK Support</a></li>
    ...
    <div class="footer-column col-four clearfix">
		...
		<p><a href="<?php echo $base_url; ?>/contact-us">Contact Tufts Technology Services</a></p>
